...
public class CHGXC20TOXC21 extends  nc.bs.pf.change.VOConversion{
	public CHGXC20TOXC21(){
		super();
	}
	/**
	 * 获得交换后处理类 全名称
	...
	public String[] getField() {
		return new String[] {
				...
				"B_ndryweight->B_noutput",		//数量
				"B_nwetweight->B_noutput",	
				...
				"B_vlastbillid->B_pk_flouryield_h",
				"B_vlastbillrowid->B_pk_flouryield_b",
				"B_vlastbilltype->H_pk_billtype",
				"B_csourcebillcode->H_vbillno",
				"B_vsourcebillid->B_pk_flouryield_h",
				"B_vsourcebillrowid->B_pk_flouryield_b",
