 ...
 *
 */
public class CHGXC77TOXC68 extends  nc.bs.pf.change.VOConversion{
	public CHGXC77TOXC68(){
		super();
	}
	/**
	 * 获得交换后处理类 全名称
	...
	public String[] getField() {
		return new String[] {
				"H_pk_corp->H_pk_corp",
				"H_pk_factory->H_pk_factory",//调出选厂
				"H_pk_factory1->H_pk_factory1",//调入选厂
				//"H_pk_beltline->H_pk_beltline",//生产线
				//"H_pk_classorder->H_pk_classorder",//班次
				"H_pk_stordoc->H_pk_stordoc",//调出仓库
				"H_pk_stordoc1->H_pk_stordoc1",//调出仓库
				"H_pk_minarea->B_pk_deptdoc",//调出部门--取样单位
				"B_pk_deptdoc1->B_pk_deptdoc1",//调出部门--取样单位
