...
public class XC51BillData extends BillData{
	@Override
	...
	public String getChangeClass() throws Exception {
		return "nc.bs.pf.changedir.CHGXC51TOXC37MOD";
	}
	...
	public UFBoolean[] getIsChangeNum() throws Exception {
		if(BillStockTool.getInstrance().getTypetosetnum()==null){
			...
			return BillStockTool.getInstrance().getTypetosetnum().get(PubBillTypeConst.billtype_openingentry);
		}
	}
}
