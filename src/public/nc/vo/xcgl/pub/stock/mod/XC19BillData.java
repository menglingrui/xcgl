 ...
 *
 */
public class XC19BillData extends BillData{
	...
	public String getChangeClass() throws Exception {
		return "nc.bs.pf.changedir.CHGXC19TOXC37MOD";
	}
	...
	public UFBoolean[] getIsChangeNum() throws Exception {
		if(BillStockTool.getInstrance().getTypetosetnum()==null){
			...
			return BillStockTool.getInstrance().getTypetosetnum().get(PubBillTypeConst.billtype_Drugconsume);
		}
	}
