...
public class XC68BillData extends BillData{
	...
	public String getChangeClass() throws Exception {
		return "nc.bs.pf.changedir.CHGXC68TOXC37MOD";
	}
	...
	public UFBoolean[] getIsChangeNum() throws Exception {
		if(BillStockTool.getInstrance().getTypetosetnum()==null){
			...
			return BillStockTool.getInstrance().getTypetosetnum().get(PubBillTypeConst.billtype_genotherout);
		}
	}
