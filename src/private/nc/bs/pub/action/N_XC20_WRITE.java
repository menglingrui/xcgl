 ...
 * @author mlr
 */
public class N_XC20_WRITE extends AbstractCompiler2 {
...
try{
	...
	BsUniqueCheck.FieldUniqueCheck(headvo, 
			new String[]{"pk_billtype","dbilldate","pk_factory","pk_beltline","pk_classorder","vreserve1"},
			"单据类型，单据日期，选厂，生产线，矿石类型，班次组合重复!");
	super.m_tmpVo=vo;
	try {
			super.m_tmpVo = vo;
			Object retObj = null;
