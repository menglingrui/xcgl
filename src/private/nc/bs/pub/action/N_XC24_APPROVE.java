 ...
 * 
 */
public class N_XC24_APPROVE extends AbstractCompiler2 {
	...
	public Object runComClass(PfParameterVO vo) throws BusinessException {
		try {
			...
			// **自动生成供应链sale out **##########yangtao
			AutoIcBillBO icbo=new AutoIcBillBO();
			
		
			icbo.autoGenIcBill(XcPubTool.fliterPowder((HYBillVO)getVo()),vo , "4C", true, true, false);
