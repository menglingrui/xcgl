 ...
 * @author Jay
 */
public class N_XC75_UNAPPROVE extends AbstractCompiler2 {
	private java.util.Hashtable m_methodReturnHas = new java.util.Hashtable();
	private Hashtable m_keyHas = null;

	public N_XC75_UNAPPROVE() {
		super();
	}
		...
		try {
			...
			CircularlyAccessibleValueObject[] bvos= vo.m_preValueVo.getChildrenVO();
			 ...
			 if(vlastbillrowid!=null&&vlastbillrowid.trim()!=""){
				String sql=" update xcgl_general_b set nwatercontent ='', ndryweight='' where pk_general_b='"+vlastbillrowid+"'";
