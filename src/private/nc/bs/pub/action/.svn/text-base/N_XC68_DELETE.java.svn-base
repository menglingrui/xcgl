 ...
 * @author lxh
 */
public class N_XC68_DELETE extends AbstractCompiler2 {
	private java.util.Hashtable m_methodReturnHas = new java.util.Hashtable();
	private Hashtable m_keyHas = null;


	public N_XC68_DELETE() {
		super();
	}
	...
	public Object runComClass(PfParameterVO vo) throws BusinessException {
		try {
			...
			if(vo.m_preValueVo!=null){			
				bo.updateStockByBillForDelete((AggregatedValueObject)ObjectUtils.serializableClone(vo.m_preValueVo), PubBillTypeConst.billtype_genotherout);
			}
