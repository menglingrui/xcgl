 ...
 * @author Jay
 */
public class N_XC77_UNAPPROVE extends AbstractCompiler2 {
	private java.util.Hashtable m_methodReturnHas = new java.util.Hashtable();
	private Hashtable m_keyHas = null;

	public N_XC77_UNAPPROVE() {
		super();
	}
	...
	public Object runComClass(PfParameterVO vo) throws BusinessException {
		try {
		  ...
		  // ####本脚本必须含有返回值,返回DLG和PNL的组件不允许有返回值####
			...
			//判断是否存在下游，若存在不允许弃审
			ZmPubTool.checkExitNextBill(PubBillTypeConst.billtype_allocateofflour,vo.m_preValueVo.getParentVO().getPrimaryKey());
