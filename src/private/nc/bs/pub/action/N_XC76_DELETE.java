 ...
 * @author Jay
 */
public class N_XC76_DELETE extends AbstractCompiler2 {
	private java.util.Hashtable m_methodReturnHas = new java.util.Hashtable();
	private Hashtable m_keyHas = null;


	public N_XC76_DELETE() {
		super();
	}
		...
		try {
			CircularlyAccessibleValueObject[] bvos= vo.m_preValueVo.getChildrenVO();
			 ...
			 if(vlastbillid!=null&&vlastbillid.trim()!=""){
				 String sql=" update xcgl_weighdoc set iswaterref='N'"+ " where pk_weighdoc='"+vlastbillid+"'";
