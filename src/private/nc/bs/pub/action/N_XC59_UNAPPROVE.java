 ...
 * @author mlr
 */
public class N_XC59_UNAPPROVE extends AbstractCompiler2 {
	private java.util.Hashtable m_methodReturnHas = new java.util.Hashtable();
	private Hashtable m_keyHas = null;

	public N_XC59_UNAPPROVE() {
		super();
	}
	...
	private void checkNexctExist(AggregatedValueObject bill) throws BusinessException {
		...
		String wsql="  isnull(dr,0)=0 and  pk_qualityprice_h ='"+pk+"'";
		List list=(List) dao.retrieveByClause(QualityPorB1VO.class, wsql);
		
		if(list==null || list.size()==0){
			return;
		}
		
		QualityPorB1VO bvo= (QualityPorB1VO) list.get(0);
