...
import nc.bs.xcgl.saleweighdoc.SaleWeighdocBO;
 ...
 * @author ddk
 */
public class N_XC25_APPROVE extends AbstractCompiler2 {
	...
	public Object runComClass(PfParameterVO vo) throws BusinessException {
		try {
			...
			//审批时生成销售送样单
			SaleWeighdocBO bo=new SaleWeighdocBO();
