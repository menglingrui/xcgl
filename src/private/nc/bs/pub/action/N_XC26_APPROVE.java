...
import nc.bs.xcgl.invent.AdjustBO;
 ...
 * 
 */
public class N_XC26_APPROVE extends AbstractCompiler2 {
	...
	public Object runComClass(PfParameterVO vo) throws BusinessException {
		try {
			...
			Object retObj = null;
		AdjustBO a = new AdjustBO();
		a.InventoryAdj(getVo(), vo);
