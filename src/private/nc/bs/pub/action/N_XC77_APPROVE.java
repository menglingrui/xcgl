...
import nc.bs.xcgl.allocateflour.AllocateflourBO;
 ...
 * @author jay
 */
public class N_XC77_APPROVE extends AbstractCompiler2 {
	...
	public Object runComClass(PfParameterVO vo) throws BusinessException {
		try {
			...
			//审批生成其它出库和其它入库单
			AllocateflourBO bo=new AllocateflourBO();
