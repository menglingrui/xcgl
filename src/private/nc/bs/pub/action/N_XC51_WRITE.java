 ...
 * @author ddk
 */
public class N_XC51_WRITE extends AbstractCompiler2 {
...
try{
	...
	try {
			...
			if(vo.m_preValueVo!=null){
				bo.updateStockByBillForSave((AggregatedValueObject)ObjectUtils.serializableClone(vo.m_preValueVo), PubBillTypeConst.billtype_openingentry);
			}
