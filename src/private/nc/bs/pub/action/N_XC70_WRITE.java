 ...
 * @author yangtao
 */
public class N_XC70_WRITE extends AbstractCompiler2 {
...
try{
	...
	try {
			...
			String ctcode=(String) hvo.getAttributeValue("ct_code");
			
			BsUniqueCheck.FieldUniqueChecks((SuperVO)hvo, new String[]{"ct_code"}, null, "合同编码"+ctcode+"已经存在");
