...
public class BillQueryDlg extends HYQueryDLG implements IinitQueryData2{
	...
	public  BillQueryDlg(Container parent) {
		super(parent,null,pk_corp,PubNodeCodeConst.NodeCode_saleweighdoc,operator,null,"REF");
	}
...
//		String whersql="and xcgl_weighdoc.issaleref='N' and  isnull(xcgl_weighdoc.dr,0)=0  and xcgl_weighdoc.pk_corp='"+pk_corp+"'";
