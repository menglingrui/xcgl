...
public class ClientUI extends XCDefBillManageUI{
	...
	public void setDefaultData() throws Exception {
		...
		getBillCardPanel().getHeadItem("pk_billtype").setValue(PubBillTypeConst.billtype_qualityprice);
	}
	
	@Override
	protected String getBillNo() throws Exception {
		return HYPubBO_Client.getBillNo(PubBillTypeConst.billtype_qualityprice,
	...
	public boolean beforeEdit(BillEditEvent e) {
		...
		if (key.equals("vformula")) {
			setEditFormula(getBillCardPanel(),"vformulacode","vformula",row,"pk_qualityprice_b");
		}
		return true;
	}
	/**
