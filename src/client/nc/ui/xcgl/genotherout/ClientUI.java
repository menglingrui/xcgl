...
public class ClientUI extends XCDefBillManageUI{
	...
	public void setDefaultData() throws Exception {
		...
		getBillCardPanel().getHeadItem("pk_billtype").setValue(PubBillTypeConst.billtype_genotherout);
	}
	@Override
	protected String getBillNo() throws Exception {
		return HYPubBO_Client.getBillNo(PubBillTypeConst.billtype_genotherout, 
