...
/**
 *@author jay
 *销售出库矿区分摊计算到销售出库后台交换类 
 */
import nc.bs.pf.change.ConversionPolicyEnum;
import nc.vo.pf.change.UserDefineFunction;

public class CHGXC29BTOXC24 extends  nc.bs.pf.change.VOConversion{
	public CHGXC29BTOXC24(){
		super();
	}
	/**
	 * 获得交换后处理类 全名称
...
//				"H_vmemo->H_vmemo",
				...
				"H_crowno->H_crowno",
//				"B_vmemo->B_vmemo",
//				"B_pk_invmandoc->H_pk_invmandoc",
//				"B_pk_invbasdoc->H_pk_invbasdoc",
//				"B_vcrowno->H_vcrowno",
//				"B_pk_father->H_pk_father",
//				"B_ndryweight->B_ndryweight",		//数量
//				"B_vlastbillcode->H_vlastbillcode",
//				"B_vlastbillid->H_vlastbillid",
//				"B_vlastbillrowid->H_vlastbillrowid",
//				"B_vlastbilltype->H_vlastbilltype",
//				"B_csourcebillcode->H_csourcebillcode",
//				"B_vsourcebillid->H_vsourcebillid",
//				"B_vsourcebillrowid->H_vsourcebillrowid",
//				"B_vsourcebilltype->H_vsourcebilltype",
		};
	}
	/**
	 * 获得赋值类型的交换规则
