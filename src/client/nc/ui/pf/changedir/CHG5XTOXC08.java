 ...
 *
 */
public class CHG5XTOXC08 extends nc.ui.pf.change.VOConversionUI{
	/**
	 * CHGXC13TOXC31 默认构造
	 */
	public CHG5XTOXC08() {
	...
	public String[] getField() {
		return new String[] {
				"H_pk_deptdoc->B_cindeptid",
				"H_pk_corp->B_cincorpid",
				"H_pk_calbody->H_cincbid",
//				"H_vuserdef9->H_vdef9",
//				"H_vuserdef8->H_vdef8",
//				"H_vuserdef7->H_vdef7",
//				"H_vuserdef6->H_vdef6",
...
//				"B_vfree4->B_vfree4",
//				"B_vfree3->B_vfree3",
				"B_vlastbillid->B_cbillid",
				"B_vlastbillrowid->B_cbill_bid",
		        "B_vlastbilltype->H_cbilltype",
		        "B_vlastbillcode->B_vcode",
//				"B_vbatchcode->B_vbatch",
		    	"B_vsourcebillid->B_cbillid",
				"B_vsourcebillrowid->B_cbill_bid",
		        "B_vsourcebilltype->H_cbilltype",
		        "B_csourcebillcode->B_vcode",
...
//		    "B_pk_corp->B_ctakeoutcorpid"
	...
	public String[] getFormulas() {
		return new String[]{
				"B_ngrossweight->B_nnum-tonumber(B_vbdef20)",
				"B_nnetweight->B_nnum-tonumber(B_vbdef20)"
		};
	}
	/**
	 * 返回用户自定义函数
