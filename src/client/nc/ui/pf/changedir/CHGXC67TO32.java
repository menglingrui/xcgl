 ...
 *
 */
public class CHGXC67TO32 extends VOConversionUI{
		...
		//        "B_nexchangeotobrate->B_nexchangeotobrate",
		 ...
		 //       "B_cprojectid->B_cprojectid", 
		  //      "B_cprojectphaseid->B_cprojectphaseid",
		        ...
		        "B_cupsourcebillid->H_pk_salesettledroop_h",
		        "B_cupsourcebillbodyid->B_pk_salesettledroop_b",
...
//		        "B_pk_defdoc19->B_pk_defdoc19", "B_pk_defdoc20->B_pk_defdoc20",
	...
	public String[] getFormulas() {
		return new String[] {
		    	...
		    	"H_fstatus->1",
		        "H_fcounteractflag->0",
		        "B_noriginalcurtaxprice->(B_nreserve10+B_nreserve8)/B_namount", 
		        "H_finvoicetype->0",
