 ...
 *
 */
public class CHGXC25TOXC76 extends nc.ui.pf.change.VOConversionUI {
	/**
	 * CHGXC25TOXC29 默认构造
	 */
	public CHGXC25TOXC76() {
		super();
	}
	/**
	 * 获得交换后处理类 全名称
...
//				"B_nnetweight->B_ndryweight",
				//"B_ndryweight->B_ndryamount",//净重--干重
				"H_vmemo->H_vmemo",
				"B_vmemo->B_vmemo",
				...
				"H_vdef9->H_vdef9",
				//交换客户
				//"H_vreserve1->H_custbasid",
				//"H_vreserve2->H_custid",
