...
public class CHGXC68TOXC69 extends  nc.bs.pf.change.VOConversion{
	/**
	 * CHGXC68TOXC69 默认构造
	 */
	public CHGXC68TOXC69() {
		super();
	}
	/**
	 * 获得交换后处理类 全名称
	...
	public String[] getField() {
		return new String[] {
				...
				"B_nwetweight->B_nwetweight",
				"B_vlastbillcode->H_vbillno",
				"B_vlastbillid->B_pk_general_h",
				"B_vlastbillrowid->B_pk_general_b",
				"B_vlastbilltype->H_pk_billtype",
				"B_csourcebillcode->B_vbillno",
				"B_vsourcebillid->B_pk_gerenal_h",
				"B_vsourcebillrowid->B_pk_gerenal_b",
				"B_vsourcebilltype->B_pk_billtype",
				
				 "B_pk_father->B_pk_father",
				 "B_vcrowno->B_vcrowno",//关联行号	vcrowno
	...
	public String[] getFormulas() {
		return new String[]{
				"B_nwetweight->B_nwetweight-tonumber(B_noutnum)",
				"B_ndryweight->B_ndryweight-tonumber(B_noutnum)",
		};
	}
	/**
	 * 返回用户自定义函数
